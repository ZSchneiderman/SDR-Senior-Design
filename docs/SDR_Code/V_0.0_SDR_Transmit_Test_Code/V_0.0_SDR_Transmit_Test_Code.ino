//Transmit Test code for SDR, from Charlie Morris, call sign: ZL2CT, additional annotations added by James Bell
// Libraries
...
static const int Mic_Gain = 0;            // Range is 0-63dB. (why?)
static const int Lineout_Gain = 20;        // Range is 13-31. 13 = 3.16 Vp-p, 31 = 1.16 Vp-p  (Why? what does this mean?)
...
AudioConnection         patchCord65(TX_I_Sideband_Switch, 0, audioOutput, 0);           // Output to the NE612 (What is the NE612?)
AudioConnection         patchCord70(TX_Hilbert_Minus_45, 0, audioOutput, 1);            // Output to the NE612 (What is the NE612?)
